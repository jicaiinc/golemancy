...
describe('Teams routes', () => {
  ...
  describe('DELETE /api/projects/:projectId/teams/:teamId', () => {
    it('deletes team and clears defaultTargetId if matching', async () => {
    ...
    it('deletes team without clearing defaultTargetId if not matching', async () => {
      vi.mocked(mocks.projectStorage.getById).mockResolvedValue({
        id: projId,
        name: 'Project',
        description: '',
        ...
        updatedAt: '',
        defaultTargetType: 'team',
        defaultTargetId: 'team-other' as TeamId,
      })
      vi.mocked(mocks.teamStorage.delete).mockResolvedValue(undefined)
