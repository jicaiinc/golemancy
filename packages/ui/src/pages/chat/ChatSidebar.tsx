      ...
      <div className="flex-1 overflow-y-auto">
        {sorted.length === 0 ? (
          ...
          sorted.map(conv => {
            ...
            const team = conv.targetType === 'team' ? teams.find(tm => tm.id === conv.targetId) : undefined
            const agent = conv.targetType === 'agent' ? agents.find(a => a.id === conv.targetId) : undefined
