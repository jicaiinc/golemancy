...
// --- Knowledge Base ---
export const SEED_KB_COLLECTIONS: KBCollection[] = [
  {
    id: 'kbc-1' as KBCollectionId,
    name: 'Brand Guidelines',
    description: 'Core brand knowledge and style guidelines',
    tier: 'hot',
    documentCount: 2,
    totalChars: 4200,
    createdAt: dayAgo,
  ...
  {
    id: 'kbc-2' as KBCollectionId,
    name: 'Research Notes',
    description: 'Collected research and analysis documents',
    tier: 'warm',
    documentCount: 3,
    totalChars: 15000,
    createdAt: dayAgo,
  ...
  {
    id: 'kbc-3' as KBCollectionId,
    name: 'Legacy Docs',
    description: 'Archived documentation from previous projects',
    tier: 'archive',
    documentCount: 1,
    totalChars: 8000,
    createdAt: dayAgo,
...
export const SEED_KB_DOCUMENTS: KBDocument[] = [
  {
    id: 'kbd-1' as KBDocumentId,
    collectionId: 'kbc-1' as KBCollectionId,
    title: 'Brand Voice',
    content: 'Our brand voice is professional yet approachable. We use clear, concise language...',
    sourceType: 'manual',
    sourceName: '',
    charCount: 2100,
    chunkCount: 0,
  ...
  {
    id: 'kbd-2' as KBDocumentId,
    collectionId: 'kbc-1' as KBCollectionId,
    title: 'Target Audience',
    content: 'Target audience prefers long-form content (2000+ words). Best posting times: Tuesday 9am, Thursday 2pm EST.',
    sourceType: 'manual',
    sourceName: '',
    charCount: 2100,
    chunkCount: 0,
  ...
  {
    id: 'kbd-3' as KBDocumentId,
    collectionId: 'kbc-2' as KBCollectionId,
    ...
    sourceType: 'upload',
    sourceName: 'competitor-analysis.pdf',
    charCount: 5000,
    chunkCount: 10,
    createdAt: dayAgo,
    updatedAt: hourAgo,
  ...
  {
    id: 'kbd-5' as KBDocumentId,
    collectionId: 'kbc-2' as KBCollectionId,
    title: 'Market Trends Report',
    content: 'AI-powered content creation tools are seeing 40% YoY growth...',
    sourceType: 'upload',
    sourceName: 'market-trends-2026.docx',
    charCount: 5000,
    chunkCount: 10,
    createdAt: hourAgo,
    updatedAt: hourAgo,
...
export const SEED_SETTINGS: GlobalSettings = {
  ...
  embedding: { providerType: 'openai', model: 'text-embedding-3-small', apiKey: 'sk-mock-embed', testStatus: 'ok' },
  theme: 'dark',
