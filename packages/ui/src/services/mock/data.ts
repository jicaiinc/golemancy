...
export const SEED_DASHBOARD_RUNTIME_STATUS: RuntimeStatus = {
  runningChats: [
    { conversationId: 'conv-1' as ConversationId, agentId: 'agent-1' as AgentId, agentName: 'Writer', title: 'Blog Draft: AI Trends', startedAt: new Date(Date.now() - 120_000).toISOString() },
  ],
  runningCrons: [],
  upcoming: [
    { cronJobId: 'cron-1' as CronJobId, cronJobName: 'Daily Summary', agentId: 'agent-1' as AgentId, agentName: 'Writer', nextRunAt: new Date(Date.now() + 3600_000).toISOString() },
    { cronJobId: 'cron-2' as CronJobId, cronJobName: 'Weekly Competitor Scan', agentId: 'agent-2' as AgentId, agentName: 'Researcher', nextRunAt: new Date(Date.now() + 86400_000).toISOString() },
  ],
  recentCompleted: [
    { type: 'chat', id: 'conv-2', agentName: 'Researcher', completedAt: new Date(Date.now() - 7200_000).toISOString(), status: 'success', durationMs: 45_000, totalTokens: 18_200 },
    { type: 'cron', id: 'cronrun-1', agentName: 'Writer', completedAt: new Date(Date.now() - 14400_000).toISOString(), status: 'success', durationMs: 12_000, totalTokens: 8_500 },
  ],
}
